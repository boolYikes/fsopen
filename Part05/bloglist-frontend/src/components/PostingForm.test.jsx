...
describe('<PostingForm />', () => {
    ...
    beforeEach(() => {
        ...
        container = render(<PostingForm addBlog={prop.addBlog} toggle={prop.toggle}/>)
    })
    ...
    test('1. Correct submission details were used', async () => {
        ...
        const mockUser = await loginService.login({username: content.author, password: content.author})
        window.localStorage.setItem(
            'loggedBlogAppUser', JSON.stringify(mockUser)
        )
