...
describe("Favorite blog", () => {
  test("the most loved blog", () => {
    assert.deepStrictEqual(listHelper.favoriteBlog(listHelper.test_blogs), {
      title: "Test1 title",
      author: "Test1",
      url: "https://test.url",
      likes: 11,
...
describe("Well endowed blog-wise", () => {
  test("the rich boi", () => {
    assert.deepStrictEqual(listHelper.mostBlogsOwned(listHelper.test_blogs), {
      author: "Test2",
      blogs: 2,
    });
  });
...
describe("Most liked author", () => {
  test("author with max likes check", () => {
    assert.deepStrictEqual(listHelper.mostLikedAuthor(listHelper.test_blogs), {
      author: "Test2",
      likes: 15,
    });
  });
